...
ZONE_IN_POLYGONS = [
    np.array([[915, 200], [1020, 200], [1020, 280], [915, 280]]),     # Въезд с 12ч
    np.array([[1170, 260], [1200, 260], [1200, 320], [1170, 320]]),   # Въезд с 3ч
    np.array([[460, 525], [795, 525], [795, 580], [460, 580]]),       # Въезд с 7ч
    # np.array([[0, 460], [60, 440], [255, 610], [0, 620]]),
]

ZONE_OUT_POLYGONS = [
    np.array([[1060, 255], [1110, 255], [1110, 280], [1060, 280]]),     # Выезд на 12 ч
    np.array([[1200, 335], [1265, 335], [1265, 360], [1200, 360]]),     # Выезд на 3ч
    np.array([[255, 450], [470, 450], [470, 500], [255, 500]]),         # Выезд на 7ч
...
class VideoProcessor:
    def __init__(
        ...
        self.trace_annotator = sv.TraceAnnotator(
            color=COLORS, position=sv.Position.BOTTOM_CENTER, trace_length=100, thickness=0
        )
